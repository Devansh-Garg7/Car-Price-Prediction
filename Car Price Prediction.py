...
l1=Label(root,text='Car Company',bg='white',fg='red',font=('Ariel',15,'bold'))
l1.place(x=30,y=100)
...
l2=Label(root,text='Year of Mfg.',bg='white',fg='red',font=('Ariel',15,'bold'))
l2.place(x=30,y=150)
e2=Entry(root,width=30)
e2.place(x=240,y=150,height=30)

l3=Label(root,text='Kilometres Driven',bg='white',fg='red',font=('Ariel',15,'bold'))
l3.place(x=30,y=200)
e3=Entry(root,width=30)
e3.place(x=240,y=200,height=30)

l4=Label(root,text='Fuel Type',bg='white',fg='red',font=('Ariel',15,'bold'))
l4.place(x=30,y=250)
...
l5=Label(root,text='Seller Type',bg='white',fg='red',font=('Ariel',15,'bold'))
l5.place(x=30,y=300)
...
l6=Label(root,text='Transmission',bg='white',fg='red',font=('Ariel',15,'bold'))
l6.place(x=30,y=350)
...
l7=Label(root,text='Owner',bg='white',fg='red',font=('Ariel',15,'bold'))
l7.place(x=500,y=100)
lst7=['First Owner','Second Owner','Third Owner','Fifth','Fourth & Above Owner','Test Drive Car']
